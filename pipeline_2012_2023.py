...
def normalize_name(text):
    ''' Normalisation des noms des fédérations pour éviter les doublons'''
    if pd.isna(text):
        return text
...
def apply_normalize_name(df):
    mapping = {
        ...
        "AIKIDO, AIKIBUDO ET AFFINITAIRES":"AIKIDO ET BUDO",
        "AIKIDO, AIKIBUDO ET A FRANCAISEINITAIRES":"AIKIDO ET BUDO",
        "ARTS ENERGETIQUES ET MARTIAUX CHINOIS (ANCIEN WUSHU)":"ARTS ENERGETIQUES ET MARTIAUX CHINOIS",
        ...
        "HALTEROPHILIE, MUSCULATION":"HALTEROPHILIE MUSCULATION",
        ...
        "LA MONTAGNE ET L'ESCALADE":"MONTAGNE ET ESCALADE",
        ...
        "OMNISPORTS PERSONNELS L'EDUCATION NATIONALE":"OMNISPORTS PERSONNELS EDUCATION NATIONALE JEUNESSE ET SPORTS",
        "OMNISPORTS PERSONNELS L'EDUCATION NATIONALE LA JEUNESSE ET SPORTS":"OMNISPORTS PERSONNELS EDUCATION NATIONALE JEUNESSE ET SPORTS",
        "OMNSISPORTS PERSONNELS L'EDUCATION NATIONALE ET JEUNESSE ET SPORTS":"OMNISPORTS PERSONNELS EDUCATION NATIONALE JEUNESSE ET SPORTS",
        ...
        "SPORTIVE ET GYMNIQUE TRAVAIL":"SPORTIVE ET GYMNIQUE TRAVAIL (FSGT)"
    }
