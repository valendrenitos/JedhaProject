...
for i,row in datalicenses.iterrows():
    quer="INSERT INTO media_table.licenses (year, code_commune, nom_commune, num_dep, region, code_fed, nom_fed, total_lic, total_f, total_h, h_1_9, h_10_19, h_20_29,h_30_59, h_60_74, h_75,  f_1_9, f_10_19, f_20_29, f_30_59, f_60_74, f_75) VALUES ('"+str(row["annee"])+"','"+str(row["code_commune"])+"','"+str(row["nom_commune"])+"','"+str(row["num_departement"])+"','"+str(row["region"])+"','"+str(row["code_fed"])+"','"+str(row["nom_fed"])+"','"+str(row["total_lic"])+"','"+str(row["total_f"])+"','"+str(row["total_h"])+"','"+str(row["h_1_9"])+"','"+str(row["h_10_19"])+"','"+str(row["h_20_29"])+"','"+str(row["h_30_59"])+"','"+str(row["h_60_74"])+"','"+str(row["h_75"])+"','"+str(row["f_1_9"])+"','"+str(row["f_10_19"])+"','"+str(row["f_20_29"])+"','"+str(row["f_30_59"])+"','"+str(row["f_60_74"])+"','"+str(row["f_75"])+"')"   
    print(quer)
    conn._execute_query(quer)
    conn.commit()
